  ...
  return (
    <div className={styles.organizerMeet}>
      ...
      <div>
        ...
        {teams.length !== 0 && (
          <div className={styles.organizerMeet__section}>
            <span className={styles.organizerMeet__titleGroup}>Команды</span>
            <br></br>
            {teams.map((el, index) => (
              <>
                <div className={styles.organizerMeet__section}>

                  <span key={index} className={styles.organizerMeet__title}>
                    {el.deptName}
                  </span>
                  <br></br>
                  <span key={index} className={styles.organizerMeet__subTitle}>
                    {el.role}
                  </span>
                </div>
              </>
